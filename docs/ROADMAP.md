...
KODA is currently at **B0 — Repository Bootstrap: COMPLETE**. **R0 — Architecture Feasibility: REQUIRES BARE METAL** (Azure guest execution was blocked before WHP testing; the architecture is not disproven).
...
## R0 — Architecture Feasibility — REQUIRES BARE METAL
